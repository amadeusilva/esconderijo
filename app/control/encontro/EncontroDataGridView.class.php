 ...
 */
class EncontroDataGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        //id`, `numero`, `evento_id`, `local_id`, `dt_inicial`, `dt_final`, `tema`, `divisa`, `cantico
        $col_id              = new TDataGridColumn('id', 'COD.', 'center', '5%');
        $col_num        = new TDataGridColumn('num', 'Evento', 'rigth');
        $col_evento_id        = new TDataGridColumn('evento_id', 'Evento', 'rigth');
        $col_local_id            = new TDataGridColumn('local_id', 'Local', 'rigth');
